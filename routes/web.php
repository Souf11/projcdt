...
Route::prefix('professor')->name('professor.')->group(function () {
    ...
    Route::middleware(['auth:professor'])->group(function () {
        ...
        Route::get('/courses/{course}/edit', [ProfessorController::class, 'editClass'])->name('editClass');
        
        Route::put('/courses/{course}', [ProfessorController::class, 'updateClass'])->name('updateClass');       
        Route::delete('/courses/{course}', [ProfessorController::class, 'deleteClass'])->name('deleteClass');
    });
});
